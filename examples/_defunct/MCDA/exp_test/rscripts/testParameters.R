...
args[2]= "/data0"
args[3] = 6 #numero criterios

args[4] = "2,1,1,3,2,3" #criteriaWeights
args[5] = "5,20,NA" #categoriesLowerProfiles
args[6] = "min" #criteriaMinMax
args[7] = "NA,NA,60" #vetos

args[4] = "2,1,2,3,4,1" 
args[5] = "1,1,2,2,98,100,102,104,20,20,24,32,8,16,20,20,8,16,20,20,0,5,2,1"
args[5] = "1,2,4,5,2,6,8,10,2,4,6,10,4,6,8,10,10,6,4,0,5,0,0,0"
#args[5] = "1,2,4,5, 2,6,8,10, 2,4,6,10,4,6,8,10,10,6,4,0,5,0,0,0"
args[6] = "min,min,min,min,max,max"
#args[7] = "NA,NA,NA,NA, NA,NA,NA,NA, NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA, NA,NA,NA,NA"
args[7] = "NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA"
majorityThreshold = 6
